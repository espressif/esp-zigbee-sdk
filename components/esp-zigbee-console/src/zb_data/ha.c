...
static const esp_zcl_ha_device_t s_ha_device_table[] = {
    ...
    HA_DEVICE_ENTRY_UNSUPPORTED(level_control_switch, ESP_ZB_HA_LEVEL_CONTROL_SWITCH_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(on_off_output, ESP_ZB_HA_ON_OFF_OUTPUT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(level_controllable_output, ESP_ZB_HA_LEVEL_CONTROLLABLE_OUTPUT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(scene_selector, ESP_ZB_HA_SCENE_SELECTOR_DEVICE_ID),
    HA_DEVICE_ENTRY(configuration_tool, ESP_ZB_HA_CONFIGURATION_TOOL_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(remote_control, ESP_ZB_HA_REMOTE_CONTROL_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(combined_interface, ESP_ZB_HA_COMBINED_INTERFACE_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(range_extender, ESP_ZB_HA_RANGE_EXTENDER_DEVICE_ID),
    ...
    HA_DEVICE_ENTRY_UNSUPPORTED(simple_sensor, ESP_ZB_HA_SIMPLE_SENSOR_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(consumption_awareness, ESP_ZB_HA_CONSUMPTION_AWARENESS_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(home_gateway, ESP_ZB_HA_HOME_GATEWAY_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(smart_plug, ESP_ZB_HA_SMART_PLUG_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(white_goods, ESP_ZB_HA_WHITE_GOODS_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(meter_interface, ESP_ZB_HA_METER_INTERFACE_DEVICE_ID),
    HA_DEVICE_ENTRY(on_off_light, ESP_ZB_HA_ON_OFF_LIGHT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(dimmable_light, ESP_ZB_HA_DIMMABLE_LIGHT_DEVICE_ID),
    HA_DEVICE_ENTRY(color_dimmable_light, ESP_ZB_HA_COLOR_DIMMABLE_LIGHT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(dimmable_switch, ESP_ZB_HA_DIMMER_SWITCH_DEVICE_ID),
    ...
    HA_DEVICE_ENTRY_UNSUPPORTED(heating_cooling_unit, ESP_ZB_HA_HEATING_COOLING_UNIT_DEVICE_ID),
    ...
    HA_DEVICE_ENTRY_UNSUPPORTED(ias_control_indicating, ESP_ZB_HA_IAS_CONTROL_INDICATING_EQUIPMENT_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(ias_ancillary_control, ESP_ZB_HA_IAS_ANCILLARY_CONTROL_EQUIPMENT_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(ias_zone, ESP_ZB_HA_IAS_ZONE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(ias_warning, ESP_ZB_HA_IAS_WARNING_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(test_device, ESP_ZB_HA_TEST_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(custom_tunnel, ESP_ZB_HA_CUSTOM_TUNNEL_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORTED(custom_attr, ESP_ZB_HA_CUSTOM_ATTR_DEVICE_ID),
