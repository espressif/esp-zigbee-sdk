...
#define esp_zb_commissioning_cluster_add_attr(attr_list, attr_id, value_p) ESP_ERR_NOT_SUPPORTED
#define esp_zb_ias_zone_cluster_add_attr(attr_list, attr_id, value_p) ESP_ERR_NOT_SUPPORTED
#define esp_zb_ias_zone_cluster_set_cie_address(endpoint, cie_ieee_addr) ESP_ERR_NOT_SUPPORTED
#define esp_zb_ias_ace_get_zone_table_length(endpoint, table_size) ESP_ERR_NOT_SUPPORTED
#define esp_zb_ias_ace_get_zone_table(endpoint, table_p) ESP_ERR_NOT_SUPPORTED
#define esp_zb_ias_wd_cluster_add_attr(attr_list, attr_id, value_p) ESP_ERR_NOT_SUPPORTED
#define esp_zb_ota_cluster_add_attr(attr_list, attr_id, value_p) ESP_ERR_NOT_SUPPORTED
#define esp_zb_electrical_meas_cluster_add_attr(attr_list, attr_id, value_p) ESP_ERR_NOT_SUPPORTED
#define esp_zb_diagnostics_cluster_add_attr(attr_list, attr_id, value_p) ESP_ERR_NOT_SUPPORTED
#define esp_zb_drlc_cluster_add_attr(attr_list, attr_id, value_p) ESP_ERR_NOT_SUPPORTED

/**
 * @brief  Create an empty attribute list.
 *
 * @note  This attribute list is ready for certain cluster id to add / update attribute refer to esp_zb_xx_cluster_add_attr()
 * and esp_zb_cluster_update_attr().
 ...
 *
 */
#define esp_zb_zcl_get_attribute(endpoint, cluster_id, cluster_role, attr_id) \
    ((esp_zb_zcl_attr_t *)ezb_zcl_get_attr_desc(endpoint, cluster_id, cluster_role, attr_id, EZB_ZCL_STD_MANUF_CODE))
 ...
 *
 */
#define esp_zb_zcl_set_attribute_val(endpoint, cluster_id, cluster_role, attr_id, value_p, check) \
    ezb_zcl_set_attr_value(endpoint, cluster_id, cluster_role, attr_id, EZB_ZCL_STD_MANUF_CODE, value_p, check)
 ...
 */
#define esp_zb_zcl_get_manufacturer_attribute(endpoint, cluster_id, cluster_role, attr_id, manuf_code) \
    ((esp_zb_zcl_attr_t *)ezb_zcl_get_attr_desc(endpoint, cluster_id, cluster_role, attr_id, manuf_code))
 ...
 */
#define esp_zb_zcl_set_manufacturer_attribute_val(endpoint, cluster_id, cluster_role, manuf_code, attr_id, value_p, check) \
    ezb_zcl_set_attr_value(endpoint, cluster_id, cluster_role, attr_id, manuf_code, value_p, check)
...
/**
 * @brief Add an attribute in binary output cluster.
 *
 * @param[in] attr_list A pointer to attribute list @ref esp_zb_attribute_list_s
 * @param[in] attr_id  An attribute id to be added
 * @param[in] value_p A pointer to attribute value wants to add
 ...
 *
 */
esp_err_t esp_zb_binary_output_cluster_add_attr(esp_zb_attribute_list_t *attr_list, uint16_t attr_id, void *value_p);
 ...
 *
 */
esp_err_t esp_zb_carbon_dioxide_measurement_cluster_add_attr(esp_zb_attribute_list_t *attr_list,
                                                             uint16_t                 attr_id,
                                                             void                    *value_p);
...
/**
 * @brief Add an attribute in multistate input cluster.
 *
 * @param[in] attr_list A pointer to attribute list @ref esp_zb_attribute_list_s
 * @param[in] attr_id  An attribute id to be added
 * @param[in] value_p A pointer to attribute value wants to add
 ...
 *
 */
esp_err_t esp_zb_multistate_input_cluster_add_attr(esp_zb_attribute_list_t *attr_list, uint16_t attr_id, void *value_p);

/**
 * @brief Add an attribute in multistate output cluster.
 *
 * @param[in] attr_list A pointer to attribute list @ref esp_zb_attribute_list_s
 * @param[in] attr_id  An attribute id to be added
 * @param[in] value_p A pointer to attribute value wants to add
 ...
 *
 */
esp_err_t esp_zb_multistate_output_cluster_add_attr(esp_zb_attribute_list_t *attr_list, uint16_t attr_id, void *value_p);
 ...
 *
 */
#define esp_zb_cluster_add_attr(attr_list, cluster_id, attr_id, attr_type, attr_access, value_p) \
    TO_ESP_ERR(esp_zb_cluster_add_manufacturer_attr(attr_list, cluster_id, attr_id, EZB_ZCL_STD_MANUF_CODE, attr_type, attr_access, value_p))
 ...
 *
 */
esp_err_t esp_zb_cluster_add_manufacturer_attr(esp_zb_attribute_list_t *attr_list,
                                               uint16_t                 cluster_id,
                                               uint16_t                 attr_id,
                                               uint16_t                 manuf_code,
                                               uint8_t                  attr_type,
 ...
 *
 */
esp_err_t esp_zb_custom_cluster_add_custom_attr(esp_zb_attribute_list_t *attr_list,
                                                uint16_t                 attr_id,
                                                uint8_t                  attr_type,
                                                uint8_t                  attr_access,
                                                void                    *value_p);
...
/**
 * @brief Add an attribute in binary value cluster.
 *
 * @param[in] attr_list A pointer to attribute list @ref esp_zb_attribute_list_s
 * @param[in] attr_id  An attribute id to be added
 * @param[in] value_p A pointer to attribute value wants to add
 ...
 *
 */
esp_err_t esp_zb_binary_value_cluster_add_attr(esp_zb_attribute_list_t *attr_list, uint16_t attr_id, void *value_p);

/**
 * @brief Add an attribute in poll control cluster.
 *
 * @param[in] attr_list A pointer to attribute list @ref esp_zb_attribute_list_s
 * @param[in] attr_id  An attribute id to be added
 * @param[in] value_p A pointer to attribute value wants to add
