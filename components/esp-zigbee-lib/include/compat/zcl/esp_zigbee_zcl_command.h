...
/* Break Change: Not supported Now*/
#define esp_zb_zcl_comm_restart_device_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_comm_save_startup_params_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_comm_restore_startup_params_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_comm_reset_startup_params_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_zone_enroll_cmd_resp(cmd_resp) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_zone_status_change_notif_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_zone_enroll_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_arm_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_bypass_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_emergency_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_fire_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_panic_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_get_zone_id_map_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_get_zone_information_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_get_panel_status_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_get_bypassed_zone_list_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_get_zone_status_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_zone_status_changed_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_ace_panel_status_changed_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_wd_start_warning_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_ias_wd_squawk_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_electrical_measurement_cluster_get_profile_info_resp(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_electrical_measurement_cluster_get_measurement_profile_resp(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_drlc_load_control_event_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_drlc_cancel_load_control_event_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_drlc_cancel_all_load_control_events_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_drlc_report_event_status_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_drlc_get_scheduled_events_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
#define esp_zb_zcl_scenes_table_clear_by_index(index) ESP_ERR_NOT_SUPPORTED
#define esp_zb_zcl_thermostat_get_relay_status_log_cmd_req(cmd_req) ESP_ZB_ZCL_INVALID_TSN
...
typedef struct esp_zb_zcl_config_report_record_s {
    esp_zb_zcl_report_direction_t direction; /*!< Direction field specifies whether values of the attribute are to be reported,
...
typedef struct esp_zb_zcl_config_report_cmd_s {
    ...
    esp_zb_zcl_config_report_record_t
        *record_field; /*!< Report configuration records, @ref esp_zb_zcl_config_report_record_s */
...
typedef struct esp_zb_zcl_disc_attr_cmd_s {
    ...
    uint8_t  max_attr_number; /*!< The maximum number of attribute identifiers that are to be returned in the resulting Discover
...
typedef struct esp_zb_zcl_on_off_off_with_effect_cmd_s {
    ...
    uint8_t effect_variant; /*!< The field is used to indicate which variant of the effect, indicated in the Effect Identifier
                               field, SHOULD be triggered. */
...
typedef struct esp_zb_zcl_on_off_on_with_timed_off_cmd_s {
    ...
    uint16_t off_wait_time; /*!< The field specifies the length of time (in 1/10ths second) that the device SHALL remain "off",
                               i.e., with its OnOff attribute equal to 0x00, and guarded to prevent an on command turning the
                               device back "on" */
...
typedef struct esp_zb_zcl_comm_restart_device_cmd_s {
    ...
    } options;      /*!< Restart device options */
...
typedef struct esp_zb_zcl_comm_reset_startup_params_cmd_s {
    ...
    } options;     /*!< Reset startup parameter options */
...
typedef struct esp_zb_zcl_color_color_loop_set_cmd_s {
    ...
    uint16_t start_hue; /*!< The field specifies the starting hue to use for the color loop if the Update Start Hue field of the
...
typedef struct esp_zb_zcl_color_move_color_temperature_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint8_t move_mode; /*!< The Move Mode field of the Move Hue command, if the Move Mode field is equal to 0x00, the Rate field
                          SHALL be ignored. */
...
typedef struct esp_zb_zcl_color_step_color_temperature_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint8_t move_mode; /*!< The Move Mode field of the Step Hue command, If the Move Mode field is equal to 0x00, the Rate field
                          SHALL be ignored. */
 ...
 *
 * @note Group name currently is not supported, put empty string, Support of group names is optional, @@see ZCL specification,
 * subclause  3.6.2.2.2
 */
...
typedef struct esp_zb_zcl_ias_ace_zone_table_s {
    ...
    uint8_t           *zone_label;   /**< Zone label string pointer; NULL if not programmed */
} esp_zb_zcl_ias_ace_zone_table_t;
...
} esp_zb_zcl_ias_ace_get_zone_status_t;
...
}  esp_zb_zcl_ias_ace_arm_resp_t;

/** @brief Structure representation of Get Zone Information Response command */
...
} esp_zb_zcl_ias_ace_get_zone_info_resp_t;
...
typedef struct esp_zb_zcl_ias_ace_zone_status_changed_s {
    ...
    uint8_t  aud_notification;                       /**< Audible Notification */
    uint8_t  zone_label[ESP_ZB_ZCL_MAX_STRING_SIZE]; /**< Zone Label Field */
} esp_zb_zcl_ias_ace_zone_status_changed_t;
...
typedef struct esp_zb_zcl_ias_ace_panel_status_changed_s {
    ...
    uint8_t aud_notification;   /**< Audible Notification */
    uint8_t alarm_status;       /**< Alarm Status Field */
} esp_zb_zcl_ias_ace_panel_status_changed_t;
...
typedef struct esp_zb_zcl_ias_ace_get_panel_status_resp_s {
    ...
    uint8_t aud_notification;   /**< Audible Notification */
    uint8_t alarm_status;       /**< Alarm Status Field */
} esp_zb_zcl_ias_ace_get_panel_status_resp_t;
...
typedef struct esp_zb_zcl_ias_ace_set_bypassed_zone_list_s {
    uint8_t length;                                       /**< Number of Zones */
    uint8_t zone_id[ESP_ZB_ZCL_IAS_ACE_ZONE_TABLE_LENGTH]; /**< Zone ID array */
} esp_zb_zcl_ias_ace_set_bypassed_zone_list_t;

/** @brief Structure representation of Bypass Response command */
typedef struct esp_zb_zcl_ias_ace_bypass_resp_s {
    uint8_t length;                                              /**< Number of Zones */
    uint8_t bypass_result[ESP_ZB_ZCL_IAS_ACE_ZONE_TABLE_LENGTH]; /**< Bypass Result for Zone IDs */
} esp_zb_zcl_ias_ace_bypass_resp_t;

/** @brief IAS ACE Zone Status structure */
typedef struct esp_zb_zcl_ias_ace_zone_status_s {
    uint8_t  zone_id;      /**< Zone ID */
    uint16_t zone_status;  /**< Zone Status */
} esp_zb_zcl_ias_ace_zone_status_t;
...
}  esp_zb_zcl_ias_ace_get_zone_status_resp_t;
...
typedef struct esp_zb_electrical_measurement_profile_info_s {
    ...
    uint8_t   interval_period;         /*!< The Profile interval period for profile information response command */
...
typedef struct esp_zb_electrical_measurement_profile_s {
    ...
    void    *intervals;                 /*!< The array of attribute values intervals id for profile response command */
...
typedef struct esp_zb_zcl_thermostat_setpoint_raise_lower_request_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint8_t mode;  /*!< Mode field SHALL be set to Heat(0x00), Cool(0x01) and Both(0x02). It specifies which setpoint is to be
                      configured */
    int8_t amount; /*!< Amount field specifies the setpoint(s) are to be increased (or decreased) by, in steps of 0.1 degree
                      Celsius */
...
typedef struct esp_zb_zcl_thermostat_set_weekly_schedule_request_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint8_t num_of_transitions; /*!< Number of transitions for sequence field indicates how many individual transitions to
                                   expect for this sequence of commands */
    uint8_t day_of_week;  /*!< Day of week for sequence field represents the day of the week at which all the transitions within
                             the payload of the command SHOULD be associated to */
    uint8_t mode_for_seq; /*!< Mode for sequence field determines how the application SHALL decode the Set Point Fields of each
                             transition for the remaining of the command */
    uint16_t transition_time; /*!< Transition time field represents the start time of the schedule transition during the
                                 associated day */
    uint16_t heat_set_point;  /*!< Heat set point field represents the heat setpoint(0.01 degree Celsius resolution) to be
                                 applied, if the heat bit is enabled in the Mode For Sequence byte */
    uint16_t cool_set_point;  /*!< Cool set point field represents the cool setpoint(0.01 degree Celsius resolution) to be
                                 applied, if the cool bit is enabled in the Mode For Sequence byte */
...
typedef struct esp_zb_zcl_thermostat_get_weekly_schedule_request_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint8_t days_to_return; /*!< Days to return field indicates the number of days the client would like to return the set point
                               values for */
    uint8_t mode_to_return; /*!< Mode to return field indicates the mode(heat only, cool only or heat & cool) the client would
                               like to return the set point values for */
...
typedef struct esp_zb_metering_get_profile_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd;    /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;     /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint8_t                   interval_channel; /*!< Interval channel is used to select the quantity of interest by
                                                                                  the 'GetProfileResponse' command */
    uint32_t end_time; /*!< End time is a 32-bit value (in UTC) used to select an Intervals block from all the Intervals blocks
                          available */
    uint8_t number_of_periods; /*!< Number of periods represents the number of intervals being requested, which cannot exceed
...
typedef struct esp_zb_metering_request_fast_poll_mode_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint8_t fast_poll_update_period; /*!< Desired fast poll period (seconds) not to be less than the FastPollUpdatePeriod
                                        attribute */
...
typedef struct esp_zb_metering_get_snapshot_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint32_t earliest_start_time;            /*!< A UTC Timestamp indicating the earliest time of a snapshot to be returned by a
                                                corresponding Publish Snapshot command */
    uint32_t latest_end_time; /*!< A UTC Timestamp indicating the latest time of a snapshot to be returned by a corresponding
                                 Publish Snapshot command */
    uint8_t snapshot_offset; /*!< This field identifies the individual snapshot to be returned, where multiple snapshots satisfy
                                the selection criteria specified by the other fields in this command */
    uint32_t
        snapshot_cause; /*!< This field is used to select only snapshots that were taken due to a specific cause,
...
typedef struct esp_zb_metering_get_sampled_data_cmd_s {
    esp_zb_zcl_basic_cmd_t    zcl_basic_cmd; /*!< Basic command info */
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    uint16_t sample_id; /*!< Unique identifier allocated to this Sampling session. This field allows devices to match response
                           data with the appropriate request */
    uint32_t earliest_sample_time; /*!< A UTC Timestamp indicating the earliest time of a sample to be returned. Samples with a
                                      timestamp equal to or greater than the specified EarliestSampleTime shall be returned */
    uint8_t  sample_type;          /*!< Sample_type identifies the required type of sampled data */
    uint16_t number_of_samples; /*!< This filed represents the number of samples being requested. This value cannot exceed the
                                   size stipulated in the MaxNumberOfSamples field. If fewer samples are available for the time
                                   period, only those available are returned */
...
/** @brief DRLC LoadControlEvent command payload */
typedef struct esp_zb_zcl_drlc_load_control_event_payload_s {
    ...
    uint16_t device_class;                      /*!< Device Class bit field */
    uint8_t  utility_enrollment_group;          /*!< Utility enrollment group */
    uint32_t start_time;                        /*!< UTC start time; 0 = now */
    uint16_t duration_in_minutes;               /*!< Duration in minutes, max 1440 */
    uint8_t  criticality_level;                 /*!< Criticality level */
    uint8_t  cooling_temperature_offset;        /*!< Cooling setpoint offset (+0.1 °C) */
    uint8_t  heating_temperature_offset;        /*!< Heating setpoint offset (+0.1 °C) */
    int16_t  cooling_temperature_set_point;     /*!< Cooling set point (0.01 °C) */
    int16_t  heating_temperature_set_point;     /*!< Heating set point (0.01 °C) */
    int8_t   average_load_adjustment_percentage; /*!< Max energy usage limit (%) */
    uint8_t  duty_cycle;                        /*!< Max on-state duty cycle (%) */
    uint8_t  event_control;                     /*!< Event control options */
} esp_zb_zcl_drlc_load_control_event_payload_t;

/** @brief DRLC CancelLoadControlEvent command payload */
typedef struct esp_zb_zcl_drlc_cancel_load_control_event_payload_s {
    ...
    uint8_t  utility_enrollment_group; /*!< Utility enrollment group */
    uint8_t  cancel_control;          /*!< Cancel control */
    uint32_t effective_time;          /*!< Effective time; 0 = now */
} esp_zb_zcl_drlc_cancel_load_control_event_payload_t;

/** @brief DRLC CancelAllLoadControlEvents command payload */
...
/** @brief DRLC ReportEventStatus command payload */
typedef struct esp_zb_zcl_drlc_report_event_status_payload_s {
    uint32_t issuer_event_id;                          /*!< Issuer event id */
    uint8_t  event_status;                             /*!< Event status */
    uint32_t event_status_time;                        /*!< UTC timestamp */
    uint8_t  criticality_level_applied;                /*!< Criticality applied */
    uint16_t cooling_temperature_set_point_applied;    /*!< Cooling setpoint applied */
    uint16_t heating_temperature_set_point_applied;    /*!< Heating setpoint applied */
    int8_t   average_load_adjustment_percentage_applied; /*!< Load adjustment % applied */
    uint8_t  duty_cycle_applied;                       /*!< Duty cycle applied */
    uint8_t  event_control;                            /*!< Event control */
    uint8_t  signature_type;                           /*!< Signature type */
    uint8_t  signature[42];                            /*!< Signature */
} esp_zb_zcl_drlc_report_event_status_payload_t;

/** @brief DRLC GetScheduledEvents command payload */
typedef struct esp_zb_zcl_drlc_get_scheduled_events_payload_s {
    uint32_t start_time;       /*!< Minimum start time of events to return */
    uint8_t  number_of_events; /*!< Max events; 0 = no limit */
    uint32_t issuer_event_id;  /*!< Min issuer event id; 0xFFFFFFFF = unused */
...
typedef struct esp_zb_zcl_drlc_load_control_event_req_s {
    ...
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    esp_zb_zcl_drlc_load_control_event_payload_t
        payload; /*!< The payload of LoadControlEvent, @see esp_zb_zcl_drlc_load_control_event_payload_t */
...
typedef struct esp_zb_zcl_drlc_cancel_load_control_event_req_s {
    ...
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    esp_zb_zcl_drlc_cancel_load_control_event_payload_t
        payload; /*!< The payload of CancelLoadControlEvent, @see esp_zb_zcl_drlc_cancel_load_control_event_payload_t */
...
typedef struct esp_zb_zcl_drlc_cancel_all_load_control_events_req_s {
    ...
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    esp_zb_zcl_drlc_cancel_all_load_control_events_payload_t
        payload; /*!< The payload of CancelAllLoadControlEvents, @see esp_zb_zcl_drlc_cancel_all_load_control_events_payload_t
                  */
...
typedef struct esp_zb_zcl_drlc_report_event_status_req_s {
    ...
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    esp_zb_zcl_drlc_report_event_status_payload_t
        payload; /*!< The payload of ReportEventStatus, @see esp_zb_zcl_drlc_report_event_status_payload_t */
...
typedef struct esp_zb_zcl_drlc_get_scheduled_events_req_s {
    ...
    esp_zb_zcl_address_mode_t address_mode;  /*!< APS addressing mode constants refer to esp_zb_zcl_address_mode_t */
    esp_zb_zcl_drlc_get_scheduled_events_payload_t
        payload; /*!< The payload of GetScheduledEvents, @see esp_zb_zcl_drlc_get_scheduled_events_payload_t */
 ...
 *       For array, array16, array32, and long string data types, the first 2 bytes should represent the number of elements in
 * the array. The size of data is only required when the type is ESP_ZB_ZCL_ATTR_TYPE_SET, ESP_ZB_ZCL_ATTR_TYPE_BAG, or
 * CUSTOM_TYPE.
 *
 */
...
typedef struct esp_zb_zcl_alarms_alarm_cmd_req_s {
    ...
    uint8_t alarm_code;  /*!< Identifying code for the cause of the alarm, as given in the specification of the cluster whose
...
typedef struct esp_zb_zcl_recall_scene_message_s {
    ...
    esp_zb_zcl_scenes_extension_field_t
        *field_set; /*!< The extension field of Zigbee scenes cluster,{{cluster_id, length, value},..., {cluster_id,
...
typedef struct esp_zb_ota_file_optional_s {
    ...
    esp_zb_ieee_addr_t upgrade_file_destination; /*!< Indicates that this OTA file contains security credential/certificate data
                                                    or other type of information that is specific to a particular device.*/
...
typedef struct esp_zb_ota_file_header_s {
    ...
    esp_zb_ota_file_optional_t
        optional; /*!< The optional header controlled by the filed control, @see esp_zb_ota_file_optional_t */
...
typedef struct esp_zb_zcl_ota_upgrade_value_message_s {
    esp_zb_device_cb_common_info_t info;           /*!< The common information for Zigbee device callback */
    uint16_t                       upgrade_status; /*!< The update status for Zigbee ota update */
...
typedef struct esp_zb_zcl_ota_upgrade_server_status_message_s {
    ...
    uint8_t   server_status; /*!< The status of OTA upgrade server, which can refer to esp_zb_ota_upgrade_server_status_t */
    uint16_t  image_type;    /*!< The image type of OTA file */
    uint32_t  version;       /*!< The version of OTA file */
    uint32_t *upgrade_time;  /*!< The upgrade time of OTA file, which indicates the interval time when the received OTA image
                                will be updated */
...
typedef struct esp_zb_zcl_thermostat_weekly_schedule_transition_s {
    ...
    uint16_t
        heat_setpoint; /*!< This field represents the heat setpoint to be applied at this associated transition start time. */
    uint16_t
        cool_setpoint; /*!< this field represents the cool setpoint to be applied at this associated transition start time.*/
...
typedef struct esp_zb_zcl_metering_get_profile_resp_info_offered_s {
    uint32_t end_time; /*!< It is 32-bit value (in UTC) representing the end time of the most chronologically recent interval
                          being requested */
    uint8_t status;    /*!< Status of 'GetProfile' command */
    uint8_t profile_interval_period; /*!< Represents the interval or time frame used to capture metered Energy, Gas, and Water
                                        consumption for profiling purposes */
    uint8_t number_of_periods_delivered; /*!< Number of periods represents the number of intervals being requested, it cannot
                                            exceed the MaxNumberOfPeriodsDelivered attribute. If fewer intervals are available
                                            for the time period, only those available are returned */
    esp_zb_uint24_t *
        intervals; /*!< Series of interval data captured using the period specified by the 'ProfileIntervalPeriod' attribute.
                        The content of the interval data depends of the type of information requested using the Channel field in
                      the 'GetProfile' command, and will represent the change in that information since the previous interval */
...
typedef struct esp_zb_zcl_metering_get_profile_message_s {
    ...
    esp_zb_zcl_metering_get_profile_resp_info_offered_t
        resp_info_offered; /*!< The info used for 'GetProfileResponse' command, to response 'GetProfile' command.
...
typedef struct esp_zb_zcl_metering_get_profile_resp_message_s {
    ...
    esp_zb_uint24_t
        *intervals; /*!< Series of interval data captured using the period specified by the ProfileIntervalPeriod field. The
                       content of the interval data depends of the type of information requested using the Channel field in
                       GetProfile command, and will represent the change in that information since the previous interval */
...
typedef struct esp_zb_zcl_metering_request_fast_poll_mode_resp_info_offered_s {
    uint8_t applied_update_period_in_seconds; /*!< The period at which metering data shall be updated, shall be greater than or
                                                 equal to the minimum FastPollUpdatePeriod Attribute and less than or equal to
                                                 the FastPollUpdatePeriod in RequestFastPollMode command */
...
typedef struct esp_zb_zcl_metering_request_fast_poll_mode_message_s {
    ...
    uint8_t duration; /*!< Desired duration (minutes) for the server to remain in fast poll mode not to exceed 15 minutes */
    esp_zb_zcl_metering_request_fast_poll_mode_resp_info_offered_t
        resp_info_offered; /*!< The info used for 'RequestFastPollModeResponse' command, to response 'RequestFastPollMode'
                              command. The info SHOULD be offered by user, otherwise, the response has no sense */
...
typedef struct esp_zb_zcl_poll_control_check_in_req_message_s {
    esp_zb_device_cb_common_info_t
             info;           /*!< The common information for Zigbee device callback, refer to esp_zb_device_cb_common_info_t */
...
struct esp_zb_zcl_metering_tou_delivered_payload_s {
    esp_zb_uint48_t current_summation_delivered; /*!< An unsigned 48-bit integer that returns the value of the
                                                    CurrentSummationDelivered attribute at the stated snapshot timestamp */
    uint32_t bill_to_date_delivered; /*!< An unsigned 32-bit integer that provides a value for the costs in the current billing
                                        period */
    uint32_t bill_to_date_time_stamp_delivered; /*!< A UTC timestamp that indicates when the value of the associated
                                                   BillToDateDelivered parameter was last updated */
    uint32_t projected_bill_delivered; /*!< An unsigned 32-bit integer that provides a value indicating what the estimated state
                                          of the account will be at the end of the billing period based on past consumption */
    uint32_t projected_bill_time_stamp_delivered; /*!< A UTC timestamp that indicates when the associated ProjectedBillDelivered
    ...
    uint8_t number_of_tiers_in_use;  /*!< An 8-bit integer representing the number of tiers in use at the time the snapshot was
                                        taken */
    esp_zb_uint48_t *tier_summation; /*!< The Publish Snapshot command contains N elements of CurrentTierNSummationDelivered
...
struct esp_zb_zcl_metering_tou_received_payload_s {
    esp_zb_uint48_t current_summation_received; /*!< An unsigned 48-bit integer that returns the value of the
                                                   CurrentSummationReceived attribute at the stated snapshot timestamp */
    uint32_t bill_to_date_received; /*!< An unsigned 32-bit integer that provides a value for the costs in the current billing
                                       period */
    uint32_t bill_to_date_time_stamp_received; /*!< A UTC timestamp that indicates when the value of the associated
                                                  BillToDateReceived parameter was last updated */
    uint32_t projected_bill_received; /*!< An unsigned 32-bit integer that provides a value indicating what the estimated state
                                         of the account will be at the end of the billing period based on past generation */
    uint32_t projected_bill_time_stamp_received; /*!< A UTC timestamp that indicates when the associated ProjectedBillReceived
                                                    parameter was last updated */
    uint8_t bill_received_trailing_digit; /*!< An 8-bit BitMap used to determine where the decimal point is located in the
                                             BillToDateReceived and ProjectedBillReceived fields */
    uint8_t number_of_tiers_in_use;  /*!< An 8-bit integer representing the number of tiers in use at the time the snapshot was
                                        taken */
    esp_zb_uint48_t *tier_summation; /*!< The Publish Snapshot command contains N elements of CurrentTierNSummationReceived
                                        attributes from the TOU Information Set. The Metering server shall send only the number
                                        of tiers in use, as stated in this command */
} EZB_PACKED_END;
...
struct esp_zb_zcl_metering_block_tier_delivered_payload_s {
    ...
    uint8_t number_of_tiers_and_block_thresholds_in_use; /*!< An 8-bit BitMap representing the number of tiers and block
                                                            thresholds in use at the time the snapshot was taken */
    esp_zb_uint48_t *tier_block_summation; /*!< The Publish Snapshot command contains N elements of the Block Information
                                              Attribute Set (Delivered). The metering server shall send only the number of Tiers
                                              and Blocks in use as stated in this command */
} EZB_PACKED_END;
...
struct esp_zb_zcl_metering_block_tier_received_payload_s {
    ...
    uint8_t number_of_tiers_and_block_thresholds_in_use; /*!< An 8-bit BitMap representing the number of tiers and block
                                                            thresholds in use at the time the snapshot was taken */
    esp_zb_uint48_t *tier_block_summation; /*!< The Publish Snapshot command contains N elements of the Block Information
                                              Attribute Set (Received). The metering server shall send only the number of Tiers
                                              and Blocks in use as stated in this command */
} EZB_PACKED_END;
...
typedef struct esp_zb_zcl_metering_block_tier_delivered_no_billing_payload_s
    esp_zb_zcl_metering_block_tier_delivered_no_billing_payload_t;
...
typedef struct esp_zb_zcl_metering_block_tier_received_no_billing_payload_s
    esp_zb_zcl_metering_block_tier_received_no_billing_payload_t;
...
union esp_zb_zcl_metering_snapshot_sub_payload_s {
    ...
    esp_zb_zcl_metering_block_tier_delivered_payload_t
        block_tier_delivered; /*!< @ref esp_zb_zcl_metering_block_tier_delivered_payload_s */
    esp_zb_zcl_metering_block_tier_received_payload_t
        block_tier_received; /*!< @ref esp_zb_zcl_metering_block_tier_received_payload_s */
    esp_zb_zcl_metering_tou_delivered_no_billing_payload_t
        tou_delivered_no_billing; /*!< @ref esp_zb_zcl_metering_tou_delivered_no_billing_payload_s */
    esp_zb_zcl_metering_tou_received_no_billing_payload_t
        tou_received_no_billing; /*!< @ref esp_zb_zcl_metering_tou_received_no_billing_payload_s */
    esp_zb_zcl_metering_block_tier_delivered_no_billing_payload_t
        block_tier_delivered_no_billing; /*!< @ref esp_zb_zcl_metering_block_tier_delivered_no_billing_payload_s */
    esp_zb_zcl_metering_block_tier_received_no_billing_payload_t
        block_tier_received_no_billing; /*!< @ref esp_zb_zcl_metering_block_tier_received_no_billing_payload_s */
} EZB_PACKED_END;
...
struct esp_zb_zcl_metering_snapshot_s {
    ...
    uint32_t
        snapshot_time; /*!< This is a 32-bit value (in UTC Time) representing the time at which the data snapshot was taken. */
    uint8_t total_snapshots_found;  /*!< An 8-bit Integer indicating the number of snapshots found, based on the search criteria
                                       defined in the associated GetSnapshot command */
    uint32_t snapshot_cause;        /*!< A 32-bit BitMap indicating the cause of the snapshot */
    uint8_t  snapshot_payload_type; /*!< The SnapshotPayloadType is an 8-bit enumerator defining the format of the Snapshot
                                       Sub-Payload in this message */
...
typedef struct esp_zb_zcl_metering_get_snapshot_message_s {
    ...
    uint32_t
        snapshot_cause; /*!< This field is used to select only snapshots that were taken due to a specific cause,
                             setting 0xFFFFFFFF indicates that all snapshots should be selected, irrespective of the cause */
    esp_zb_zcl_metering_snapshot_t
        resp_info_offered; /*!< The info used for 'PublishSnapshot' command, to response 'GetSnapshot' command.
                                The info SHOULD be offered by user, otherwise, the response has no sense */
...
typedef struct esp_zb_zcl_metering_publish_snapshot_message_s {
    ...
    uint8_t total_snapshots_found; /*!< An 8-bit Integer indicating the number of snapshots found, based on the search criteria
                                      defined in the associated GetSnapshot command */
    uint8_t command_index; /*!< The CommandIndex is used to count the payload fragments in the case where the entire payload
    ...
    uint8_t total_number_of_commands; /*!< In the case where the entire payload (snapshot) does not fit into one message, the
                                           Total Number of Commands field indicates the total number of sub-commands that will
                                         be returned */
    uint32_t snapshot_cause;          /*!< A 32-bit BitMap indicating the cause of the snapshot */
    uint8_t  snapshot_payload_type;   /*!< The SnapshotPayloadType is an 8-bit enumerator defining the format of the Snapshot
                                         Sub-Payload in this message */
...
typedef struct esp_zb_zcl_metering_get_sampled_data_resp_info_offered_s {
    ...
    uint8_t  sample_type;       /*!< An 8 bit enumeration that identifies the type of data being sampled */
    uint16_t
        sample_request_interval; /*!< An unsigned 16-bit field representing the interval or time in seconds between samples */
    uint16_t number_of_samples;  /*!< Represents the number of samples being requested, cannot exceed MaxNumberOfSamples.
                                      And if fewer samples are available for the time period, only those available shall be
                                    returned */
    esp_zb_uint24_t *samples;    /*!< Series of data samples captured using the interval specified by the Sample RequestInterval
                                    field in the StartSampling command.    Invalid samples should be marked as 0xFFFFFF */
...
typedef struct esp_zb_zcl_metering_get_sampled_data_message_s {
    ...
    uint8_t  sample_type;                     /*!< An 8 bit enumeration that identifies the type of data being sampled */
    uint16_t number_of_samples; /*!< Represents the number of samples being requested, This value cannot exceed the size
                                   stipulated in the MaxNumberOfSamples field in the StartSampling command */
    esp_zb_zcl_metering_get_sampled_data_resp_info_offered_t
        resp_info_offered; /*!< The info used for 'GetSampledDataResponse' command, to response 'GetSampledData' command.
                                The info SHOULD be offered by user, otherwise, the response has no sense */
...
struct esp_zb_zcl_price_publish_price_s {
    ...
    uint32_t start_time; /*!< Denotes the time at which the signal becomes valid. Value 0x00000000 is a special time denoting
                            "now". */
    uint16_t
        duration_in_minutes; /*!< Denotes amount of time in minutes after Start Time during which the price signal is valid. */
    uint32_t
        price; /*!< Contains the price of the commodity measured in base unit of Currency per Unit of Measure with the decimal
                  point located as indicated by the Price Trailing Digit field when the commodity is delivered to premises. */
    /* Optional fields. */
    ...
    uint32_t generation_price; /*!< Contains the price of the commodity measured in base unit of Currency per Unit of Measure
                                  with the decimal point located as indicated by the Price Trailing Digit field when the
                                  commodity is received from premises. */
...
typedef struct esp_zb_zcl_price_get_current_price_message_s {
    ...
    esp_zb_zcl_price_publish_price_t
        *resp_info_offered; /*!< The info used for 'PublishPrice' command, to response 'GetCurrent' command.
                             *   The info SHOULD be offered by user, otherwise, the response has no sense */
...
typedef struct esp_zb_zcl_price_tier_label_entry_s {
    ...
    uint8_t tier_label[13]; /*!< Octet String field capable of storing a 12 character string (the first
                             ...
                             */
} esp_zb_zcl_price_tier_label_entry_t;
...
typedef struct esp_zb_zcl_drlc_load_control_event_message_s {
    ...
    esp_zb_zcl_drlc_report_event_status_payload_t
        *response; /*!< An output pointer allows the user to pass it as a parameter in response to this request */
...
typedef struct esp_zb_zcl_drlc_cancel_load_control_event_message_s {
    esp_zb_device_cb_common_info_t info; /*!< The common information for Zigbee device callback */
    esp_zb_zcl_drlc_cancel_load_control_event_payload_t
        payload; /*!< The payload of CancelLoadControlEvent request, @see esp_zb_zcl_drlc_cancel_load_control_event_payload_t */
    esp_zb_zcl_drlc_report_event_status_payload_t
        *response; /*!< An output pointer allows the user to pass it as a parameter in response to this request */
...
typedef struct esp_zb_zcl_door_lock_lock_door_message_s {
    esp_zb_device_cb_common_info_t info;   /*!< The common information for Zigbee device callback */
    uint8_t                        cmd_id; /*!< The lock or unlock command identifier */
...
typedef struct esp_zb_zcl_door_lock_lock_door_resp_message_s {
    esp_zb_device_cb_common_info_t info;   /*!< The common information for Zigbee device callback */
    uint8_t                        cmd_id; /*!< The lock or unlock response command identifier */
...
typedef struct esp_zb_zcl_report_attr_message_s {
    ...
    esp_zb_zcl_addr_t
             src_address;  /*!< The struct of address contains short and ieee address, which can refer to esp_zb_zcl_addr_s */
...
typedef struct esp_zb_zcl_read_attr_resp_variable_s {
    uint8_t status; /*!< The field specifies the status of the read operation on this attribute, ref esp_zb_zcl_status_t */
...
typedef struct esp_zb_zcl_cmd_read_attr_resp_message_s {
    esp_zb_zcl_cmd_info_t
        info; /*!< The basic information of reading attribute response message that refers to esp_zb_zcl_cmd_info_t */
...
typedef struct esp_zb_zcl_write_attr_resp_variable_s {
    uint8_t status; /*!< The field specifies the status of the write operation on this attribute */
    uint16_t
        attribute_id; /*!< The attribute id of the write attribute response, please note that when info.status does not equal
...
typedef struct esp_zb_zcl_cmd_write_attr_resp_message_s {
    esp_zb_zcl_cmd_info_t
        info; /*!< The basic information of the write attribute response message that refers to esp_zb_zcl_cmd_info_t */
...
typedef struct esp_zb_zcl_config_report_resp_variable_s {
    esp_zb_zcl_status_t
            status;    /*!< The field specifies the status of the Configure Reporting operation attempted on this attribute */
    ...
    uint16_t attribute_id; /*!< The The attribute id of configuring report response, please note that when info.status does not
                              equal ESP_ZB_ZCL_STATUS_SUCCESS, the attribute_id is reported; otherwise, it is an invalid value
                              (0xFFFF). */
...
typedef struct esp_zb_zcl_cmd_config_report_resp_message_s {
    ...
    esp_zb_zcl_config_report_resp_variable_t
        *variables; /*!< The variable items, @ref esp_zb_zcl_config_report_resp_variable_s */
...
typedef struct esp_zb_zcl_read_report_config_resp_variable_s {
    esp_zb_zcl_status_t status; /*!< The field specifies the status of the read report config operation on this attribute, refer
                                   to esp_zb_zcl_status_t */
    ...
    union {
        struct {
            ...
            __attribute__((aligned(8))) uint8_t delta[8]; /*!< Reportable change */
...
typedef struct esp_zb_zcl_cmd_read_report_config_resp_message_s {
    esp_zb_zcl_cmd_info_t info; /*!< The basic information of reading report configuration response message that refers to
                                   esp_zb_zcl_cmd_info_t */
    esp_zb_zcl_read_report_config_resp_variable_t
        *variables; /*!< The variable items, @ref esp_zb_zcl_read_report_config_resp_variable_s */
...
typedef struct esp_zb_zcl_disc_attr_variable_s {
    ...
    uint8_t  data_type; /*!< The field contain the data type of the attribute in the same attribute report field */
...
typedef struct esp_zb_zcl_cmd_discover_attributes_resp_message_s {
    esp_zb_zcl_cmd_info_t
        info; /*!< The basic information of configuring report response message that refers to esp_zb_zcl_cmd_info_t */
    uint8_t
        is_completed; /*!< A value of 0 indicates that there are more attributes to be discovered, otherwise, it is completed */
...
typedef struct esp_zb_zcl_cmd_default_resp_message_s {
    ...
    uint8_t status_code; /*!< The field specifies the nature of the error that was detected in the received command,
                                        refer to esp_zb_zcl_status_t */
...
typedef struct esp_zb_zcl_scenes_view_scene_resp_message_s {
    ...
    esp_zb_zcl_scenes_extension_field_t
        *field_set; /*!< Extension field, {{cluster_id, length, value}, ... , {cluster_id, length, value}} */
...
typedef struct esp_zb_zcl_ias_wd_start_warning_message_s {
    esp_zb_device_cb_common_info_t              info; /*!< The common information for Zigbee device callback */
    const esp_zb_zcl_ias_wd_start_warning_t *msg_in; /*!< Received Start Warning command */
...
typedef struct esp_zb_zcl_ias_wd_squawk_message_s {
    esp_zb_device_cb_common_info_t         info;   /*!< The common information for Zigbee device callback */
    const esp_zb_zcl_ias_wd_squawk_t *msg_in;     /*!< Received Squawk command */
...
typedef struct esp_zb_touchlink_get_group_info_record_s {
    ...
    uint8_t  group_type; /*!< The group type shall indicate the meaning of a group in the user interface. In the current version
                            of this specification, this value shall be set to 0x00 */
...
typedef struct esp_zb_zcl_touchlink_get_group_identifiers_resp_message_s {
    esp_zb_zcl_cmd_info_t
            info; /*!< The basic information of touchlink get group identifiers response that refers to esp_zb_zcl_cmd_info_t */
    ...
    esp_zb_touchlink_get_group_info_record_t *group_info_record_list; /*!< Group information record list , {{Group identifier,
                                                                         Group type}, ... , {Group identifier, Group type}} */
...
typedef struct esp_zb_zcl_touchlink_get_endpoint_list_resp_message_s {
    esp_zb_zcl_cmd_info_t
            info;  /*!< The basic information of touchlink get endpoint list response that refers to esp_zb_zcl_cmd_info_t */
    ...
    esp_zb_touchlink_get_endpoint_list_record_t
        *endpoint_record_list; /*!< Endpoint record list , {{Network address, Endpoint identifier, Profile identifier, Device
                               identifier, Version},
...
typedef struct esp_zb_touchlink_endpoint_information_record_s {
    ...
    uint16_t
        profile_id; /*!< The identifier of the profile supported on the endpoint specified in the endpoint identifier field */
    uint16_t device_id;     /*!< The identifier of the device description supported on the endpoint specified in the endpoint
                               identifier field */
    uint8_t device_version; /*!< The version of the device description supported by the sub-device on the endpoint specified by
                               the endpoint identifier field */
 ...
 *
 * @param[in] cmd_req Pointer to the get group identifiers request command, refer to
 * esp_zb_touchlink_send_get_group_identifiers_cmd_t
 *
 */
 ...
 *
 * @param[in] cmd_req Pointer to the endpoint information request command, refer to
 * esp_zb_touchlink_send_endpoint_information_cmd_t
 *
 */
 ...
 * @param[in] cmd_req pointer to the on-off on with recall global scene command @ref
 * esp_zb_zcl_on_off_on_with_recall_global_scene_cmd_s
 *
 * @return The transaction sequence number
 */
 ...
 *
 * @param[in]  cmd_req  pointer to the enhanced move to hue saturation command @ref
 * esp_zb_zcl_color_enhanced_move_to_hue_saturation_cmd_s
 *
 * @return The transaction sequence number
 */
uint8_t esp_zb_zcl_color_enhanced_move_to_hue_saturation_cmd_req(
 ...
 */
esp_err_t esp_zb_zcl_scenes_table_store(uint8_t                              endpoint,
                                        uint16_t                             group_id,
                                        uint8_t                              scene_id,
 ...
 *
 * @param[in]  cmd_req  pointer to the send custom cluster command request @ref
 * esp_zb_zcl_window_covering_cluster_send_cmd_req_s
 *
 * @return The transaction sequence number
 */
 ...
 *
 * @param[in]  cmd_req  pointer to the setpoint raise or lower command @ref
 ...
 * @return The transaction sequence number
 */
uint8_t esp_zb_zcl_poll_control_set_long_poll_interval_cmd_req(
    esp_zb_zcl_poll_control_set_long_poll_interval_cmd_req_t *cmd_req);

/**
 * @brief   Send Poll Control SetShortPollInterval command request
 *
 * @param[in]  cmd_req  pointer to the SetShortPollInterval command @ref
 * esp_zb_zcl_poll_control_set_short_poll_interval_cmd_req_s
 *
 * @return The transaction sequence number
 */
uint8_t esp_zb_zcl_poll_control_set_short_poll_interval_cmd_req(
    esp_zb_zcl_poll_control_set_short_poll_interval_cmd_req_t *cmd_req);
 ...
 *
 * @param[in] cmd_req Pointer to the ResetAllAlarms request of alarms cluster, refer to
 * esp_zb_zcl_alarms_reset_all_alarms_cmd_req_t
 *
 * @return The transaction sequence number
 */
 ...
 *
 * @param[in] cmd_req Pointer to the ResetAlarmLog request of alarms cluster, refer to
 ...
 *
 * @param[in] obj The object of cluster handlers will be updated in the stack if the cluster ID exists; otherwise, it will be
 * added.
 *
 * @return
 *      - ESP_OK: On success
 ...
 * @return Pointer to a compatibility snapshot of the reporting entry, or NULL if not found.
 * @note The returned pointer must not be freed. It remains valid only until the next call to this
 *       function; copy the structure if you need to keep it longer. The field @c info holds the
 *       internal handle required by @ref esp_zb_zcl_update_reporting_info.
 */
