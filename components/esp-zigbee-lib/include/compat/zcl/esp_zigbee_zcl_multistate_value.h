/*
 * SPDX-FileCopyrightText: 2025 Espressif Systems (Shanghai) CO LTDESP_ZB_ZCL_
 *
...
#warning "This file is deprecated, please include "ezbee/zcl/cluster/multistate_value.h" instead!"
