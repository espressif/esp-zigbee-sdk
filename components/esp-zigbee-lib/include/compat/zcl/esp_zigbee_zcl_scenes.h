...
#warning "This file is deprecated, please include "ezbee/zcl/cluster/scenes.h" instead!"
...
/** @brief Default value for Scene Table size */
#define ESP_ZB_ZCL_SCENES_SCENE_TABLE_SIZE_DEFAULT_VALUE 16
