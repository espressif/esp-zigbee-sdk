 ...
 * production config @ref tools/mfg_tool
 *
 ...
 *
 * @param[in]  zb_ieee_addr_t  A 64-bit ieee address of the remote device composed by array of zb_uint8_t
 ...
 *
 * @note if user wants to manually set install code instead of from production config @ref esp-zigbee-sdk/tools/mfg_tool
 *
 * @warning  Only for the non-Trust Center device (non Zigbee coordinator)!
 *
 * @param[in]  ic_str  A string of the install code
