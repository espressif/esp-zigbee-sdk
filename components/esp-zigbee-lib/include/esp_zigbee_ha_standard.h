...
#define ESP_ZB_DEFAULT_SHADE_CONFIG()                                               \
    {                                                                               \
        ...
        .shade_cfg =                                                                \
            {                                                                       \
                .status = ZB_ZCL_SHADE_CONFIG_STATUS_DEFAULT_VALUE,                 \
                .closed_limit = ZB_ZCL_SHADE_CONFIG_CLOSED_LIMIT_DEFAULT_VALUE,     \
                .mode = ZB_ZCL_SHADE_CONFIG_MODE_DEFAULT_VALUE,                     \
            },                                                                      \
    }
...
#define ESP_ZB_DEFAULT_TEMPERATURE_SENSOR_CONFIG()                                  \
    {                                                                               \
        ...
        .temp_meas_cfg =                                                            \
            {                                                                       \
                .measured_value = ZB_ZCL_ATTR_TEMP_MEASUREMENT_VALUE_UNKNOWN,       \
                .min_value = ZB_ZCL_ATTR_TEMP_MEASUREMENT_MIN_VALUE_INVALID,        \
                .max_value = ZB_ZCL_ATTR_TEMP_MEASUREMENT_MAX_VALUE_INVALID,        \
            },                                                                      \
    }
