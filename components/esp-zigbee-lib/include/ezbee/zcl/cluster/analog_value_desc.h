 ...
 *
 * @param[in] cluster_desc The analog_value cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the analog_value cluster configuration structure.
                           Use ezb_zcl_analog_value_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_analog_value_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
