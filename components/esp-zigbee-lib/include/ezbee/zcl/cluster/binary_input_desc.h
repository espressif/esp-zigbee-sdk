 ...
 *
 * @param[in] cluster_desc The binary_input cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the binary_input cluster configuration structure.
                           Use ezb_zcl_binary_input_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_binary_input_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
