 ...
 *
 * @param[in] cluster_desc The color_control cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the color_control cluster configuration structure.
                           Use ezb_zcl_color_control_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_color_control_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
