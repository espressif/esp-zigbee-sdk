 ...
 *
 * @param[in] cluster_desc The dehumidification_control cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the dehumidification_control cluster configuration structure.
                           Use ezb_zcl_dehumidification_control_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_dehumidification_control_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
