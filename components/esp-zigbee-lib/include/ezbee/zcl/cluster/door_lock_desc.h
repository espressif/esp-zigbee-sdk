 ...
 *
 * @param[in] cluster_desc The door_lock cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the door_lock cluster configuration structure.
                           Use ezb_zcl_door_lock_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_door_lock_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
