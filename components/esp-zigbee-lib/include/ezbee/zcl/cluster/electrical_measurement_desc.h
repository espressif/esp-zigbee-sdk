 ...
 *
 * @param[in] cluster_desc The electrical_measurement cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the electrical_measurement cluster configuration structure.
                           Use ezb_zcl_electrical_measurement_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_electrical_measurement_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
