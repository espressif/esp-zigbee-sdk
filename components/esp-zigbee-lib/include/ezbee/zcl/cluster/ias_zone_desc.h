 ...
 *
 * @param[in] cluster_desc The ias_zone cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the ias_zone cluster configuration structure.
                           Use ezb_zcl_ias_zone_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_ias_zone_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
