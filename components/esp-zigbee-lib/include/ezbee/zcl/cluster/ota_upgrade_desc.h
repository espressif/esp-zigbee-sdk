 ...
 *
 * @param[in] cluster_desc The ota_upgrade cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the ota_upgrade cluster configuration structure.
                           Use ezb_zcl_ota_upgrade_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_ota_upgrade_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
