 ...
 *
 * @param[in] cluster_desc The poll_control cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the poll_control cluster configuration structure.
                           Use ezb_zcl_poll_control_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_poll_control_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
