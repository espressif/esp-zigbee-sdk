 ...
 *
 * @param[in] cluster_desc The pressure_measurement cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the pressure_measurement cluster configuration structure.
                           Use ezb_zcl_pressure_measurement_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_pressure_measurement_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
