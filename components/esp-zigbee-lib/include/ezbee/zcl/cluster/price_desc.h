 ...
 *
 * @param[in] cluster_desc The price cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the price cluster configuration structure.
                           Use ezb_zcl_price_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_price_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
