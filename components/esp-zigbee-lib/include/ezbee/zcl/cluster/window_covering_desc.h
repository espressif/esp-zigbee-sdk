 ...
 *
 * @param[in] cluster_desc The window_covering cluster descriptor.
 ...
 *
 * @param[in] cluster_cfg  The pointer to the window_covering cluster configuration structure.
                           Use ezb_zcl_window_covering_cluster_server_config_t for EZB_ZCL_CLUSTER_SERVER,
                           use ezb_zcl_window_covering_cluster_client_config_t for EZB_ZCL_CLUSTER_CLIENT,
