...
## Hardware Required
* One development board with ESP32-H2 SoC (loaded with [all_device_types_app](../all_device_types_app) example).
* Another development board with ESP32-H2 SoC as communication peer (loaded with [all_device_types_app](../all_device_types_app) example or other examples).
...
I (317) cpu_start: Project name:     all_device_types_app
