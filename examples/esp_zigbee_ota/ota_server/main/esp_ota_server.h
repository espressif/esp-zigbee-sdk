...
#define ESP_OTA_SERVER_ENDPOINT       5
/* Zigbee OTA Configuration */
#define OTA_UPGRADE_FILE_VERSION      0x01010101                                            /* The test file version of the running firmware image on the device */
...
#define ESP_ZB_OTA_CONFIG()                                                 \
    {                                                                       \
        ...
        .ota_data = (uint8_t *)&ota_file_start,                             \
    }
