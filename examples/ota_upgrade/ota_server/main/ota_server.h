...
#define ESP_ZIGBEE_OTA_SERVER_EP_ID (1)
...
#define ESP_MANUF_CODE       (0x131B)
#define ESP_IMAGE_TYPE       (0x0001)
/* application release 1.0 build 02 with stack release 2.0 b00. */
#define ESP_OTA_FILE_VERSION (0x10022000)
